...
public class QueryResult
{
    ...
    {
        return "ClassPojo [languageCode = "+languageCode+", intentDetectionConfidence = "+intentDetectionConfidence+", outputContexts = "+outputContexts+", allRequiredParamsPresent = "+allRequiredParamsPresent+", action = "+action+", fulfillmentText = "+fulfillmentText+", parameters = "+parameters+", fulfillmentMessages = "+fulfillmentMessages+", queryText = "+queryText+", intent = "+intent+"]";
    }
}